...
texture = {
    ...
    "green": [("name", "tex_green"), ("type", "2d"), ("file", green_metal_path)],
    "purple": [("name", "tex_purple"), ("type", "2d"), ("file", purple_metal_path)],
    "checker": [
        ("builtin", "checker"),
        ("height", "20"),
        ("name", "texplane"),
...
def convert_scene_to_xml(
    ...
    set_attribute(light, [("diffuse", ".5 .5 .5"), ("pos", "0 0 3"), ("dir", "0 0 -1")])
    # table
...
def set_scene_object(worldbody, scene):
    ...
    for body in scene:
        ...
        # body geometry
        if shape == "cylinder":
            geom_attr[2] = ("size", "{} {} 0.05".format(str(loc[2]), str(loc[2] / 1.2)))
        elif shape == "sphere":
